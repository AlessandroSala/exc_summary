...
Thanks to the flexibility offered by the method, many further advances based on this work can be carried out. Most importantly, the implementation of a full Hartree--Fock--Bogoliubov approach, which would allow the self-consistent treatment of the mean-field and pairing interactions. On top of that, a similar approach can be used to solve other analogous problems in nuclear physics, such as in the ab-initio methods, and in other physics and engineering applications as well.
